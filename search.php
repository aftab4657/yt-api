...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <form action="search.php" method="GET" class="navbar-form navbar-left" role="search">
      <div class="form-group">
        <input type="text" name="searchBox" required="" class="form-control" placeholder="Search">
      </div>
  ...
  <?php
      ...
      $search_url = 'https://www.googleapis.com/youtube/v3/search?part=snippet&q=' . $keyword . '&&channelId=UChO5ZYvc6LGAolKe2nofu6w&maxResults=20&key=' . $api_key;
$playlist = json_decode(file_get_contents($search_url));
?>
  ...
  <img style="margin:5px;" class="img-rounded ho <?php echo $vid_cls; ?>" id="<?php echo $chk;?>" onclick="video_player('<?php echo $item->id->videoId;  ?>','<?php echo $vid_cls;  ?>','<?php echo $chk;?>')" src="<?php echo $item->snippet->thumbnails->medium->url; ?>">  
